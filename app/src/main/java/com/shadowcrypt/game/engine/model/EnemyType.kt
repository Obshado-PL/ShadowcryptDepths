...
enum class EnemyType(
    ...
    // Bosses
    BONE_WARDEN("Bone Warden", baseHp = 120, baseAttack = 14, baseDefense = 8, baseXpReward = 150, detectionRange = 12, behavior = EnemyBehavior.AGGRESSIVE, minFloor = 5, maxFloor = 5, isBoss = true),
    SHADOWCRYPT_LORD("Shadowcrypt Lord", baseHp = 250, baseAttack = 20, baseDefense = 12, baseXpReward = 500, detectionRange = 15, behavior = EnemyBehavior.AGGRESSIVE, minFloor = 10, maxFloor = 10, isBoss = true)
}
